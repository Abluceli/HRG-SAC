...
class SAC_GCN(Off_Policy):
    ...
    def __init__(self,
        ...
        if self.is_continuous:
            self.actor_net = Nn.actor_continuous_gcn(vector_dim=self.s_dim, output_shape=self.a_counts, name='actor_net',
                                                     hidden_units=hidden_units['actor_continuous'], visual_net=self.actor_visual_net)
        else:
        ...
        self.q1_net = Nn.critic_q_one_gcn(vector_dim=self.s_dim, output_shape=self.a_counts, name='q1_net',
                                        hidden_units=hidden_units['q'], visual_net=self.critic_visual_net)
        self.q1_target_net = Nn.critic_q_one_gcn(vector_dim=self.s_dim, output_shape=self.a_counts, name='q1_target_net',
                                          hidden_units=hidden_units['q'], visual_net=self.critic_visual_net)
        self.q2_net = Nn.critic_q_one_gcn(vector_dim=self.s_dim, output_shape=self.a_counts, name='q2_net',
                                          hidden_units=hidden_units['q'], visual_net=self.critic_visual_net)
        self.q2_target_net = Nn.critic_q_one_gcn(vector_dim=self.s_dim, output_shape=self.a_counts, name='q2_target_net',
                                                 hidden_units=hidden_units['q'], visual_net=self.critic_visual_net)
...
　　　　ｘ　　　　ｘｘ　　　　　　　　ｘｘ　　　ｘｘ　　　　　　　　ｘｘ　　　　ｘｘ　　　
　　　　ｘｘ　　　ｘｘ　　　　　　　　ｘｘ　　　ｘｘ　　　　　　　　ｘｘｘ　　ｘｘｘ　　　
　　　　ｘｘｘｘｘｘｘ　　　　　　　ｘｘｘ　　ｘｘｘｘｘ　　　　　　　ｘｘｘｘｘｘ　xxxxxxxxxxxxxx　
        ''')
    ...
    def train(self, adj, x , visual_s, a, r, adj_, x_, visual_s_, done):
        ...
        with tf.device(self.device):
            with tf.GradientTape() as tape:
                ...
                q1 = self.q1_net(adj, x, visual_s, a)
                q1_target = self.q1_target_net(adj_, x_, visual_s_, target_pi)
                q2 = self.q2_net(adj, x, visual_s, a)
                q2_target = self.q2_target_net(adj_, x_, visual_s_, target_pi)
            ...
            with tf.GradientTape() as tape:
                ...
                q1_s_pi = self.q1_net(adj, x, visual_s, pi)
                q2_s_pi = self.q2_net(adj, x, visual_s, pi)
