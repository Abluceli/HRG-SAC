...
algos = {
    ...
    'ddpg_gcn': {'class': 'DDPG_GCN','policy': 'off-policy', 'update': 'perStep'},
    ...
    'sac_gcn':  {'class': 'SAC_GCN','policy': 'off-policy', 'update': 'perStep'},
    'tac':      {'class': 'TAC',    'policy': 'off-policy', 'update': 'perStep'},
    'dqn':      {'class': 'DQN',    'policy': 'off-policy', 'update': 'perStep'},
    'dqn_gcn':  {'class': 'DQN_GCN','policy': 'off-policy', 'update': 'perStep'},
